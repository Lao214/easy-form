        ...
        <el-row>
            <el-col :span="4">
                <div style="height: 95vh;background-color: #d3cfdd79;padding: 11px;">
                    ...
                    <el-divider></el-divider>
                    <div class="MenuNodeTitle"> My Friends</div>
                    <div class="MenuBtn" @click="showType = 'friend'"> <i class="fa fa-users" /> Friend List</div>
                    <div class="MenuBtn"> <i class="fa fa-user-plus" /> Find Friends</div>
                    <el-divider></el-divider>
                    ...
                    <div class="list-head">
                        <div class="options">
                            <div class="radio-inputs">
                                ...
                                <label class="radio">
                                    <input type="radio" name="radio">
                                    <span class="name" @click="changeSort('SortByNameDesc')"><i class="fa fa-sort-alpha-asc"
                                            style="font-weight: 600;font-size: 18px;margin-right: 2px;" /> Name</span>
                                </label>
                                <label class="radio">
                                    <input type="radio" name="radio">
                                    <span class="name" @click="changeSort('SortByNameAsc')"><i class="fa fa-sort-alpha-desc"
                                            style="font-weight: 600;font-size: 18px;margin-right: 2px;" /> Name</span>
                                </label>
                                <label class="radio">
                                    <input type="radio" name="radio">
                                    <span class="name" @click="changeSort('SortByWriteCountDesc')"><i
                                            class="fa fa-sort-amount-desc"
                                            style="font-weight: 600;font-size: 18px;margin-right: 2px;" /> Write
                                        Count</span>
                                </label>
                                <label class="radio">
                                    <input type="radio" name="radio">
                                    <span class="name" @click="changeSort('SortByWriteCountAsc')"><i
            ...
            <div style="margin-left:15%;text-align: start;">
                ...
                <div style="margin: 1rem;display: flex;">
                    ...
                    <div class="switch-field">
                        <input type="radio" id="radio-one" name="switch-one" v-model="selectedOption" :value="0"
                            checked />
...
import Contact from '@/components/ws/Contact.vue'
import Dialog from '@/components/ws/Dialog.vue'
